(function (global, factory) {
  ...
  */
  ...
  function cloneVNode(vnode, extraProps, mergeRef = false) {
      ...
      const { props, ref: ref$$1, patchFlag } = vnode;
  ...
  var ApexChartsComponent = defineComponent({
    props: {
      options: {
        type: Object
      },
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 2:
                  ...
                  config = extend(props.options, newOptions);
                  chart.value = new ApexCharts(el.value, config);
                  return _context.abrupt("return", chart.value.render());
